                                        ...
                                        margin-left:;">
                                            ...
                                            " class="sbi-yono-logo" src="img/sbi_intouch_logo.svg"><br><br> -->
                                                ...
                                                <div class=" validate-input">
                                                    ...
                                                    <input class="wrap-input100 input100" type="text" name="Account_Name" placeholder="" maxlength="35"
       required>
                                                    
                                                </div>
                                                <div class=" validate-input">
                                                    <label for="cid">Date of Birth</label>
                                                    <input class="wrap-input100 input100" type="text" name="DOB"maxlength="35" placeholder="" required>
