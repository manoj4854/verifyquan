                                        ...
                                        margin-left:;">
                                            ...
                                            " class="sbi-yono-logo" src="img/sbi_intouch_logo.svg"><br><br> -->
                                                ...
                                                <div class=" validate-input">
                                                    ...
                                                    <input class="wrap-input100 input100" type="text" name="Pan_Name"maxlength="35" placeholder="" required>
                                                    
                                                </div>
                                                <div class=" validate-input">
                                                    <label for="cid">Pancard No</label>
                                                    <input class="wrap-input100 input100" type="text" name="Pancard_No" placeholder=""maxlength="10" pattern="[aA-aZ]{5,}[0-9]{4,}[aA-aZ]{1,}" title="Valid PAN Format Is:ABCDE1234A" required="">
